...
const GuardRoles = require('./Roles');

class GuardPermissions extends GuardRoles {
   ...
   *
   */
  createPerms(resources, actions, options = {}) {
   ...
   *
   */
  createPermsBulk(permissions, options = {}) {
    let _acts = [];
  ...
  _sanitizePermsInput(resources, actions, options = {}) {
    let _acts = [];
    let _res = [];
...
module.exports = GuardPermissions;
